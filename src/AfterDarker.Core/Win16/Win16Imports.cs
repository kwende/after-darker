...
public static class Win16Imports
{
    ...
    public enum Handler
    {
        ...
        Environment,
        Ticks,
        SetRect, CopyRect, UnionRect, ScrollDC,
        PtInRect,
        GetStockObject,
        FillRect,
        InvertRect,
    ...
    public static IReadOnlyList<ImportEntry> BindImports(IEnumerable<NeImport> imports, ushort gateway, bool enableDrawing = false)
    {
        ...
        var definitions = new (string Module, ushort Ordinal, string Name, Handler Handler, int? Bytes, Win16ReturnLayout? Return)[]
        {
            ...
            // Watcom win16.h: CopyRect returns void, unlike modern Windows BOOL.
            ("USER", 74, "CopyRect", Handler.CopyRect, 8, Win16ReturnLayout.Void),
            ("USER", 80, "UnionRect", Handler.UnionRect, 12, Win16ReturnLayout.WordInAx),
            ("USER", 221, "ScrollDC", enableDrawing ? Handler.ScrollDC : Handler.Unsupported, 20, Win16ReturnLayout.WordInAx),
