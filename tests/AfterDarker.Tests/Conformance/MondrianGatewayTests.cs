...
{
    private const ushort Code = Tutorial08MondrianInitialize.Caller, Gateway = Tutorial08MondrianInitialize.Gateway;
    private const ushort Data = Tutorial08MondrianInitialize.HostData, Stack = Tutorial08MondrianInitialize.Stack, DllData = 0x28;
    ...
    private sealed class Probe : IDisposable
    {
        ...
        public SegmentedGuest.CpuState Run(List<byte> code)
        {
            ...
            Guest.DispatchGateway = () => Calls.Add(Tutorial08MondrianInitialize.DispatchImport(Guest, Bindings, Services));
